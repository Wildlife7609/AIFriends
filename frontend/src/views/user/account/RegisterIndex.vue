        ...
        <div class="login-card">
            ...
            <div class="login-fields">
                <div class="field-group">
                    <label>Email</label>
                    <input v-model="email" type="email" placeholder="you@example.com" @keyup.enter="handleRegister" />
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    ...
                    <input v-model="confirmPassword" type="password" placeholder="••••••••" @keyup.enter="handleRegister" />
                </div>
            </div>
            ...
            <div class="login-actions">
                <button class="btn btn-primary w-full" @click="handleRegister">Register</button>
            </div>
